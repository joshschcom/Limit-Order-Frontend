      ...
      <main>
        <section className="landing-hero">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions"><Link className="button accent hero-primary" href={defaultTradePath}>Open app <ArrowUpRight size={17} /></Link><Link className="button ghost" href="/stats">Protocol stats</Link></div>
            <span className="network-chip hero-network">{seltraConfig.chainId === 43113 ? "Avalanche Fuji testnet" : "Avalanche C-Chain"}</span>
          </div>
          <TerminalPreview />
        </section>
        <LiveStrip />
        <section className="landing-section how-it-works">
          ...
          <div className="feature-grid">
            ...
            <article><Activity size={20} /><h3>Two ways to fill.</h3><p>Keepers route the best DEX quote across venues, or Seltra matches a crossing order directly.</p></article>
